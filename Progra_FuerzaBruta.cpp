...
using namespace std;
using namespace std::chrono; // Para facilitar el uso de chrono
...
// Basada en el algoritmo estándar de distancia de edición recursiva
// Fuente: "Introduction to Algorithms" por Cormen, Leiserson, Rivest y Stein
int editDistanceBruteForce(const string& S1, const string& S2, int i, int j) {
    ...
    // Idea basada en la extensión del algoritmo de distancia de edición para considerar transposiciones
    // Fuente: Artículo "An O(ND) Difference Algorithm and Its Variations" por Eugene W. Myers
